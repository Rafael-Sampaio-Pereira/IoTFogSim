...
def load_humans(project_name, simulation_core):
    file_path = 'projects/'+project_name+'/humans.json'
    if os.path.exists(file_path):
        with open(file_path, 'r') as humans_file:
...
def load_links(project_name, simulation_core):
    file_path = 'projects/'+project_name+'/links.json'
    if os.path.exists(file_path):
...
def load_appliances(project_name, simulation_core):
    file_path = 'projects/'+project_name+'/appliances.json'
    if os.path.exists(file_path):
